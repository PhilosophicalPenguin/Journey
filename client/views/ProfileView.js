...
var ProfileView = Backbone.View.extend({
    ...
    render: function() {
        ...
        var newSimilarPositionsView = new SimilarPositionsView({
            model: this.model
        });
        this.$el.find("#similarpositions-div").append(newSimilarPositionsView.el);

        this.$el.append('<div id="similarprofiles-div"></div>');
        ...
        this.listenTo(newSimilarPeopleModel, 'similarPeopleReceived', function() {
            ...
            if (people.length > 0) {
                $('#similarprofiles-div').append("<h2> Similar Profiles: </h2>");
            }
            ...
            var similarPeopleThumbnailsCollectionView = new ThumbnailsCollectionView({
                collection: similarPeopleThumbnailCollection
            });
